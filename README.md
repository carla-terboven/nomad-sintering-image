![docker image](https://github.com/carla-terboven/nomad-sintering-image/actions/workflows/docker-publish.yml/badge.svg)

# carla-terboven's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of carla-terboven. 
...
```sh
curl -L -o nomad-oasis.zip "https://github.com/carla-terboven/nomad-sintering-image/raw/main/nomad-oasis.zip"
```
...
your `docker-compose.yaml` with `ghcr.io/carla-terboven/nomad-sintering-image:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/carla-terboven/nomad-sintering-image/manifests/main": unauthorized`
